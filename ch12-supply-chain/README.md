...
```
ch12-supply-chain/
├── requirements_vulnerable.txt  # 취약한 의존성 (>= 범위 지정)
...
**예상 출력:**
```
test_tools.py::TestDependencyFiles::test_vulnerable_requirements_exist PASSED [ 20%]
test_tools.py::TestDependencyFiles::test_secure_requirements_exist PASSED     [ 40%]
test_tools.py::TestDependencyFiles::test_scan_script_syntax PASSED           [ 60%]
test_tools.py::TestDependencyFiles::test_check_hashes_syntax PASSED          [ 80%]
test_tools.py::TestDependencyFiles::test_secure_uses_pinned_versions PASSED  [100%]
